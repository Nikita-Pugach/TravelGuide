...
| **Manager** | Управление турами, обработка бронирований и чат поддержки пользователей |
| **Tourist** | Зарегистрированный пользователь: просмотр каталогов, добавление в избранное, написание отзывов, бронирование туров, чат с поддержкой |
...
│   ├── ReviewsController.cs    - Отзывы на туры, отели, достопримечательности
...
│       ├── Booking.cs
│       ├── FavoriteTour.cs
│       └── Enums.cs      - Перечисления (Role, TourType, BookingStatus и др.)
